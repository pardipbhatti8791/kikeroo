  ...
  return (
    <div className='commonbody-bg commonbody-topPadding'>
      <section className='page-commonPadding font-20'>
        <Container>
          <h1 className='widget-title mb-5'>Terms of service</h1>
          <p>
            This website is operated by Kikeroo SRL. Throughout the site, the
            terms “we”, “us” and “our” refer to Kikeroo SRL. Kikeroo SRL offers
          ...
          <h2 className='widget-title mt-5 pt-5'>Online store terms</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>General Conditions</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>
          ...
          <p>Any reliance on the material on this site is at your own risk.</p>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>Products or Services</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>Optional Tools</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>Third-party links </h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>
            User coments, feedback and other submissions
          </h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>Personal information</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'>Prohibited Uses</h2>
          <p>
          ...
          <p>
            In no case shall Kikeroo SRL, our directors, officers, employees,
          ...
          <h2 className='widget-title mt-5 pt-5'>Indemnification</h2>
          <p>
            You agree to indemnify, defend and hold harmless Kikeroo SRL and our
          ...
          <h2 className='widget-title mt-5 pt-5'>Severability </h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'> Termination</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'> Entire Agreement</h2>
          <p>
          ...
          <h2 className='widget-title mt-5 pt-5'> Governing Law</h2>
          <p>
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of Via Francesco Cilea 10, Bologna, 45,
            40141, Italy.
          </p>
          <h2 className='widget-title mt-5 pt-5'>
          ...
          <h2 className='widget-title mt-5 pt-5'>Contact Information</h2>
          <p>
            Questions about the Terms of Service should be sent to us at{' '}
            <a href='mailto:info@kikeroo.com'>info@kikeroo.com</a>.
          </p>
        </Container>
      </section>
    </div>
